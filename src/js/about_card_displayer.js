        ...
        <div class="dynamic-box-1 fade-in">
            ...
            <div class="dynamic-box-1__audio">
                <div class="audio-player">
                    <p>Titre: ID</p>
                    <audio src="../src/audio/Synthwave-ID.wav" controls></audio>
                </div>
                <div class="audio-player">
                    <p>Titre: Silence</p>
                    <audio src="../src/audio/Silence.wav" controls></audio>
                </div>
                <div class="audio-player">
                    <p>Titre: Next Year</p>
                    <audio src="../src/audio/Next-Year.wav" controls></audio>
                </div>
                <div class="audio-player">
                    <p>Titre: ID</p>
                    <audio src="../src/audio/color-bass-vacs.wav" controls></audio>
                </div>
            </div>
        </div>
    `;
        ...
        <div class="dynamic-box-1 fade-in">
            ...
            <div class="vids">
                        ...
                        <video class="img-size" muted autoplay loop>
                            <source src="../src/vids/swing2.MP4" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <video class="img-size" muted autoplay loop>
                            <source src="../src/vids/swing3.MP4" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
            </div>
        </div>
        ...
        <div class="dynamic-box-1 fade-in">
            ...
            <div class="dynamic-box-1__img">
                <div class="dynamic-box-1__img_title">
                    <img class="img-size" id="ariane_img" src="../src/img/ariane.png" alt="Dynamic Image">
                    <h1>Amicale ARIANE</h1>
                </div>
                <div class="dynamic-box-1__img_title">
                    <img class="img-size" id="core_img" src="../src/img/core.png" alt="">
                    <h1>Amicale CORE</h1>
                </div>
            </div>
        </div>
